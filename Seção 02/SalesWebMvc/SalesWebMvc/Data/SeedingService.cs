...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed() {
            ...
            Seller s1 = new Seller(1, "Bob Braw", "bob@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s2 = new Seller(2, "Maria Elcida", "maria@gmail.com", new DateTime(1986, 4, 21), 2700.0, d3);
            Seller s3 = new Seller(3, "Marcos Pontes", "marcos@gmail.com", new DateTime(1979, 4, 21), 2654.0, d2);
            Seller s4 = new Seller(4, "Sara Joshua", "sara@gmail.com", new DateTime(1995, 4, 21), 3754.0, d1);
            Seller s5 = new Seller(5, "Felipe Nunes", "felipe@gmail.com", new DateTime(1992, 4, 21), 9587.0, d4);
            Seller s6 = new Seller(6, "Germano Frank", "germano@gmail.com", new DateTime(1990, 4, 21), 3541.0, d4);
